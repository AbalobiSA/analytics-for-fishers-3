...
/*============================================================================
 ...
 ============================================================================*/
        ...
        function display() {
            let xValues = ctrl.data.map(record => record.key);
            let yValues = ctrl.data.map(record => d3.values(record).slice(1));

            // get all possible z values from all entries
            // for hetrogenous categories
            let zValues = ctrl.data.reduce((set, item) => {
            ...
            let legendBuffer = legendRowsNeeded(zValues.length, ctrl.itemsperrow) * 60;
            let margin = {top: 20, right: 20, bottom: legendBuffer, left: 80};
            ...
            let container = $element.find("div")[1];
            ...
            let legend = svg.selectAll(".legend")
                ...
                .attr("transform", function (d, i) {
                    return "translate(0," + legendYPostionStart + ")";
                })
    ...
    angular.module('app')
        .component('stackedBarChart', {
            templateUrl: 'components/charts/stacked-bar-chart/stacked-bar-chart.template.html',
